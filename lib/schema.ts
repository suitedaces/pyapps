...
export const AppSchema = z.object({
  ...
  description: z.string().describe('Short description of what the app does. Max 1 sentence.'),
...
//   template: z.string().describe('Name of the template used to generate the app.'),
  ...
  additional_dependencies: z.array(z.string()).describe('Additional dependencies required by the app'),
  has_additional_dependencies: z.boolean().describe('Whether additional dependencies are required'),
