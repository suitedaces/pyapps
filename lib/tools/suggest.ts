...
const SuggestionsSchema = z.object({
    ...
    keyQuestions: z
        ...
        .max(5)
        .describe("Analytical questions that explore relationships between columns, identify patterns, or highlight insights. Example: ['How do sales correlate with customer ratings?', 'Which categories show the strongest growth?']. These are questions you believe the user would like to know the answer to.")
