    ...
    async write() {
        ...
        const report = [
            ...
            ...this.operations.map(op => [
                ...
                '',
                Object.entries(op)
                    .filter(([key]) => !['name', 'duration', 'cost', 'startUsage', 'endUsage', 'bytesPerSecond'].includes(key))
...
async function testS3Performance() {
    ...
    const sandbox = await Sandbox.create({
        apiKey: process.env.E2B_API_KEY || 'e2b_45ff57d2cbb35f978d452964b459efad92e97c61',
    ...
    try {
        ...
        for (const test of tests) {
            ...
            report.addOperation(test.name, duration, cost, startUsage, endUsage, {
                bytesPerSecond
            });
        }
        ...
        report.addOperation('Memory Stress Test (100MB parallel writes)', duration, cost, startUsage, endUsage);
