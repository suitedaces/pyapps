  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-bg dark:bg-darkBg">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">Login to Grunty 🧐</CardTitle>
        ...
        <CardFooter className="flex flex-col space-y-4">
          <div className="relative w-full">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-bg dark:bg-darkBg px-2 text-text dark:text-darkText">Or continue with</span>
            </div>
          </div>
