...
>(({ side = 'right', className, children, ...props }, ref) => (
    <SheetPortal>
        ...
        <SheetPrimitive.Content
            ref={ref}
            className={cn(
                'fixed z-[100] h-full gap-4 bg-background shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out',
                'w-[85vw] max-w-[400px]',
                side === 'left' && [
                ...
                side === 'top' && [
                    'inset-x-0 top-0 border-b h-auto',
                    'data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top'
                ],
                side === 'bottom' && [
                    'inset-x-0 bottom-0 border-t h-auto',
